        ...
        <div class="masthead">
            <div class="masthead-content text-white">
                <div class="container-fluid px-4 px-lg-0">
                    ...
                    <p class="mb-5">O God, Father of goodness, you revealed your love to the humble and to the children, by raising in your Church, St. Magdalene of Canossa to be the servant of the poor, grant that we may seek you above all things and served the poor and the little ones in a true spirit of charity and humility. Through Christ our Lord. Amen.</p>
                    <!-- * * * * * * * * * * * * * * *-->
