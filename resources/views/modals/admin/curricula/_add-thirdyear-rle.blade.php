<div class="modal fade" id="thirdRLE" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light" id="exampleModalLabel">Add RLE To Third Year</h5>
            ...
            @csrf
                <div class="modal-body px-5" id="subject">
                    ...
                    <div class="form-group inputs_RLEThird m-4">
                      <div class="form-row d-flex align-items-center">
                        ...
                        <div class="col-2">
                          ...
                          <i class="fas fa-plus-square mr-2 mt-3 text-success addThirdRLE" style="font-size: 2rem"></i>
...
<script>
  $(document).ready(function(){
    $(this).on("click", ".addThirdRLE", function()
      {var html =
        '<div class="form-row d-flex align-items-center">\
            <div class="col mb-3">\
                <label for="validationCustom03">Add Subject</label>\
            ...
            <i class="fas fa-plus-square mr-2 mt-3 text-success addThirdRLE" style="font-size: 2rem"></i>\
            <i class="fas fa-minus-square mt-3 text-danger removeThirdRLE" style="font-size: 2rem"></i>\
        </div>'
      $('.inputs_RLEThird').append(html);
    // console.log('hello');
    });

    $(this).on("click", ".removeThirdRLE", function(){
