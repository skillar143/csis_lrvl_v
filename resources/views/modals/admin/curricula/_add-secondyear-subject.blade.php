<div class="modal fade" id="secondCurr" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light" id="exampleModalLabel">Add Subject To Second Year</h5>
            ...
            @csrf
                <div class="modal-body px-5" id="subject">
                    ...
                    <div class="form-group inputs_second m-4">
...
<script>
  $(document).ready(function(){
    $(this).on("click", ".addSecond", function()
      {var html =
        '<div class="form-row d-flex align-items-center">\
            <div class="col mb-3">\
                <label for="validationCustom03">Add Subject</label>\
      ...
      $('.inputs_second').append(html);
    // console.log('hello');
    });

    $(this).on("click", ".removeSecond", function(){
