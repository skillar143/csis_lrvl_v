<div class="modal fade" id="fourthCurr" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light" id="exampleModalLabel">Add Subject To Fourth Year</h5>
                <button class="close text-light" type="button" data-dismiss="modal" aria-label="Close">
                <i class="fa fa-window-close" aria-hidden="true"></i>
                </button>
            </div>
            <form  action="{{ route('curr.store',[$course->id ,"4"]) }}" method="POST">
            @csrf
                <div class="modal-body" id="subject">
                    ...
                    <div class="form-group inputs_fourth m-4">
...
<script>
  $(document).ready(function(){
    $(this).on("click", ".addFourth", function()
      {var html =
        '<div class="form-row d-flex align-items-center">\
            <div class="col mb-3">\
                <label for="validationCustom03">Add Subject</label>\
